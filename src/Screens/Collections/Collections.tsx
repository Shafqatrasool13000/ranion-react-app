			        ...
			        <div className="row justify-content-center mb-30_reset">
			        	...
			        	<div className="col-lg-4 col-md-6 col-sm-8">
			        		<div className="collections space-y-10 mb-30">
			        			...
			        			<div className="collections_footer justify-content-between">
			        				<h5 className="collection_title"><a href="Collections.html">Colorful Abstract collection
			        					</a></h5>
			        				<a href="#" className="likes space-x-3">
			        					<i className="ri-heart-3-fill"></i>
			        	...
			        	<div className="col-lg-4 col-md-6 col-sm-8">
			        		<div className="collections space-y-10 mb-30">
			        			...
			        			<div className="collections_footer justify-content-between">
			        				<h5 className="collection_title"><a href="Collections.html">Photography Art collection
			        					</a></h5>
			        				<a href="#" className="likes space-x-3">
			        					<i className="ri-heart-3-fill"></i>
			        	...
			        	<div className="col-lg-4 col-md-6 col-sm-8">
			        		<div className="collections space-y-10 mb-30">
			        			...
			        			<div className="collections_footer justify-content-between">
			        				<h5 className="collection_title"><a href="Collections.html">Fantasy Art collection
			        					</a></h5>
			        				<a href="#" className="likes space-x-3">
			        					<i className="ri-heart-3-fill"></i>
			        					<span className="txt_md">2.1k</span>
			        	...
			        	<div className="col-lg-4 col-md-6 col-sm-8">
			        		<div className="collections space-y-10 mb-30">
			        			...
			        			<div className="collections_footer justify-content-between">
			        				<h5 className="collection_title"><a href="Collections.html">Pop Art collection
			        					</a></h5>
			        				<a href="#" className="likes space-x-3">
			        					<i className="ri-heart-3-fill"></i>
			        					<span className="txt_md">3.5k</span>
			        	...
			        	<div className="col-lg-4 col-md-6 col-sm-8">
			        		<div className="collections space-y-10 mb-30">
			        			...
			        			<div className="collections_footer justify-content-between">
			        				<h5 className="collection_title"><a href="Collections.html">Contemporary Art collection
			        					</a></h5>
			        				<a href="#" className="likes space-x-3">
			        					<i className="ri-heart-3-fill"></i>
			        					<span className="txt_md">7.2k</span>
